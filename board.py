...
class Board:
    ...
    def compute_score(self):
        ...
        computetree = LinkedBST()
        computetree._root = BSTNode(self)
        ...
        computetree._root.left = left_board
        computetree._root.right = right_board
        left_board.move_random()
        right_board.move_random()
